...
This suggests that the TOF stepping in to remove maintainship responsibilities
...
1. Contributors promoted to maintainers knowingly make changes that impact the
   ...
   build the community's trust in the their decision making.
...
expected absenses or hand over reponsibilities, other times that may not happen.
It's likely that unresponsiveness requires requires a fair margin in favour of
